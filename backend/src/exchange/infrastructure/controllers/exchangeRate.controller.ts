...
export const convertAmount = async (req: Request, res: Response<ConvertAmountResponseDto | ErrorResponseDto>) => {
...
export const getRate = async (req: Request, res: Response<GetExchangeRateResponseDto | ErrorResponseDto>) => {
